...
const (
	LogicalRouterPolicyActionAllow   = "allow"
	LogicalRouterPolicyActionDrop    = "drop"
	LogicalRouterPolicyActionReroute = "reroute"
)

type PolicyRouteAction string

var (
	PolicyRouteActionAllow   = PolicyRouteAction(LogicalRouterPolicyActionAllow)
	PolicyRouteActionDrop    = PolicyRouteAction(LogicalRouterPolicyActionDrop)
	PolicyRouteActionReroute = PolicyRouteAction(LogicalRouterPolicyActionReroute)
)
